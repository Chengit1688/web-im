...
<script lang="ts" setup>
  ...
  import { deleVersion, getVersionList, upVersionStatus} from '@/api/version';
  import {columns,platformsList,statusList} from "./columns"
  ...
  const loadDataTable = async (res) => { // table 请求配置
    ...
    delete params.time
    return await getVersionList(params);
  };
  // 搜索
