<template>
  <div class="table-toolbar">
    ...
    <div class="flex items-center table-toolbar-right" v-if="showRight">
      <!--顶部右侧区域-->
      ...
      <!--表格设置单独抽离成组件-->
      <ColumnSetting :selectionCheck="selectionCheck"/>
    </div>
  </div>
  <div class="s-table">
    <n-data-table
    ...
    <div class="flex items-center table-toolbar-left" style="position: absolute; bottom: 15px;">
